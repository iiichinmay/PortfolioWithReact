        ...
        <ul className="flex justify-around mt-7">
          ...
          <li>
            ...
            <p class=" text-black text-sm">
              ...
              <br /> https://portfolio-with-react-brown.vercel.app/
            </p>
          </li>
          ...
          <li>
            <h1 className="title-style ">YouTube Channels</h1>
              <div className="flex items-center space-x-2">
                <img src="./images/cavlogs.png" alt="CA Vlogs" className="icon-style"/>
                <a href="https://www.youtube.com/@CAVlogsLovesYouAlways" className="text-black hover:underline">
                  CA Vlogs
                </a>
              </div>

              <div className="flex items-center space-x-2">
                <img src="./images/sas.png" alt="SAS Videos" className="icon-style"/>
                <a href="https://www.youtube.com/@SASVideos" className="text-black hover:underline">
                  SAS Videos
                </a>
              </div>
            </li>
            ...
            <li>
              <h1 className="font-bold mt-14 border border-black rounded-2xl p-3 shadow-black shadow-2xl bg-black text-yellow-300">
